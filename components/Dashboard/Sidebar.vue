...
<template>
  ...
  <div class="sidebar">
    <!-- sidebar logo -->
    <NuxtLink tag="a" class="sidebar__logo" :to="{ name: 'index' }">
    ...
    <ul class="sidebar__nav">
      ...
      <!-- collapse -->
      <v-list class="sidebar__nav-item">
        <v-list-group value="Pages" class="sidebar__nav-item">
      ...
      <li class="sidebar__nav-item">
        <NuxtLink tag="a" class="sidebar__nav-link" to="/admin/movie/">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
