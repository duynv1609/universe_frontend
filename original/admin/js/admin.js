$(document).ready(function () {
  ...
  $('.filter__item-menu li').on('click', function () {
    ...
    const item = $(this)
    const id = item.closest('.filter').attr('id')
    $('#' + id)
  ...
  $('.profile__mobile-tabs-menu li').on('click', function () {
    const text = $(this).text()
    const item = $(this)
    const id = item.closest('.profile__mobile-tabs').attr('id')
    $('#' + id)
  ...
  $('.form__video-upload').on('change', function () {
    const videoLabel = $(this).attr('data-name')
  ...
  $('.form__gallery-upload').on('change', function () {
    ...
    const galleryLabel = $(this).attr('data-name')
