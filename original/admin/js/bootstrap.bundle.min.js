...
!(function (t, e) {
    ...
    return (
      ...
      (n._removeElement = function (t) {
        ...
        if ((e(t).removeClass('show'), e(t).hasClass('fade'))) {
          const i = s.getTransitionDurationFromElement(t)
          e(t)
  ...
  e(document)
    .on('click.bs.button.data-api', '[data-toggle^="button"]', function (t) {
      ...
      if (
        ...
        ;(i.tagName !== 'LABEL' || (o && o.type !== 'checkbox')) &&
  ...
  const v = (function () {
    ...
    return (
      ...
      (n._slide = function (t, n) {
        ...
        const h = n || (l && this._getItemByDirection(t, l))
        const u = this._getItemIndex(h)
        ...
        if (
          ...
          if (e(this._element).hasClass('slide')) {
            ...
            const p = parseInt(h.getAttribute('data-interval'), 10)
            p
              ...
              : (this._config.interval =
                  this._config.defaultInterval || this._config.interval)
            const m = s.getTransitionDurationFromElement(l)
            e(l)
      ...
      (t._jQueryInterface = function (n) {
        return this.each(function () {
          ...
          let r = o({}, m, e(this).data())
          typeof n === 'object' && (r = o({}, r, n))
          const s = typeof n === 'string' ? n : r.slide
          if (
      ...
      (t._dataApiClickHandler = function (n) {
        ...
        if (i) {
          ...
          if (r && e(r).hasClass('carousel')) {
            const a = o({}, e(r).data(), e(this).data())
  ...
  const b = 'collapse'
  const y = e.fn[b]
  const w = { toggle: !0, parent: '' }
  const E = { toggle: 'boolean', parent: '(string|element)' }
  const T = (function () {
    function t(t, e) {
      ...
      for (
        ...
        const r = n[i]
        const a = s.getSelectorFromElement(r)
        const l = [].slice
    ...
    return (
      ...
      (n.show = function () {
        ...
        if (
          ...
          if ((e(this._element).trigger(r), !r.isDefaultPrevented())) {
            ...
            const c = s.getTransitionDurationFromElement(this._element)
            e(this._element)
              .one(s.TRANSITION_END, function () {
                e(o._element)
          ...
          if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
            ...
            if (o > 0)
              for (let r = 0; r < o; r++) {
                ...
                const l = s.getSelectorFromElement(a)
                if (l !== null)
      ...
      (t._getTargetFromElement = function (t) {
        const e = s.getSelectorFromElement(t)
        return e ? document.querySelector(e) : null
      }),
      (t._jQueryInterface = function (n) {
        return this.each(function () {
          const i = e(this)
          let r = i.data('bs.collapse')
          const s = o({}, w, i.data(), typeof n === 'object' && n ? n : {})
          if (
            (!r &&
              s.toggle &&
              typeof n === 'string' &&
  ...
  const S = (function () {
    for (let t = ['Edge', 'Trident', 'Firefox'], e = 0; e < t.length; e += 1)
      if (C && navigator.userAgent.includes(t[e])) return 1
    return 0
  })()
  const D =
    C && window.Promise
  ...
  const x = C && !(!window.MSInputMethodContext || !document.documentMode)
  const j = C && /MSIE 10/.test(navigator.userAgent)
  function L(t) {
    return t === 11 ? x : t === 10 ? j : x || j
  }
  function P(t) {
  ...
  function F(t) {
    return t.parentNode !== null ? F(t.parentNode) : t
  }
  function R(t, e) {
  ...
  function Q(t) {
    ...
    const i = L(10) && getComputedStyle(n)
  ...
  function X(t) {
    ...
    const r = t.nodeName === 'HTML' ? Q(t.ownerDocument) : {}
  ...
  function K(t, e) {
    ...
    const a = I(t)
    const l = k(e)
    const c = parseFloat(l.borderTopWidth)
    const h = parseFloat(l.borderLeftWidth)
    ...
    if (((u.marginTop = 0), (u.marginLeft = 0), !i && o)) {
      const f = parseFloat(l.marginTop)
  ...
  function Z(t, e, n, i) {
    ...
    let r = { top: 0, left: 0 }
    const s = o ? J(t) : R(t, O(e))
    if (i === 'viewport') r = G(s, o)
    else {
      let a = void 0
      i === 'scrollParent'
        ? (a = I(A(e))).nodeName === 'BODY' &&
          (a = t.ownerDocument.documentElement)
        : (a = i === 'window' ? t.ownerDocument.documentElement : i)
      const l = K(a, s, o)
      if (a.nodeName !== 'HTML' || $(s)) r = l
      else {
        const c = Q(t.ownerDocument)
        const h = c.height
        const u = c.width
  ...
  const vt = C && /Firefox/i.test(navigator.userAgent)
  function bt(t, e, n) {
    const i = st(t, function (t) {
      return t.name === e
    })
  ...
  function Et(t) {
    ...
    const i = wt.slice(n + 1).concat(wt.slice(0, n))
    return e ? i.reverse() : i
  }
  const Tt = 'flip'
  const Ct = 'clockwise'
  const St = 'counterclockwise'
  function Dt(t, e, n, i) {
    const o = [0, 0]
    ...
    return (
      (c = c.map(function (t, i) {
        ...
        return t
          .reduce(function (t, e) {
            return t[t.length - 1] === '' && ['+', '-'].includes(e)
  ...
  const Nt = {
    ...
    modifiers: {
      ...
      preventOverflow: {
        ...
        enabled: !0,
        fn: function (t, e) {
          let n = e.boundariesElement || P(t.instance.popper)
          t.instance.reference === n && (n = P(n))
          const i = ht('transform')
          ...
          return (
            c.forEach(function (t) {
              const e = ['left', 'top'].includes(t) ? 'primary' : 'secondary'
              h = Y({}, h, u[e](t))
            }),
            (t.offsets.popper = h),
            t
      ...
      arrow: {
        ...
        fn: function (t, e) {
          ...
          const g = k(t.instance.popper)
          const _ = parseFloat(g['margin' + h])
          const v = parseFloat(g['border' + h + 'Width'])
          let b = m - t.offsets.popper[u] - _ - v
          return (
        ...
        fn: function (t, e) {
          ...
          return (
            s.forEach(function (a, l) {
              ...
              const h = t.offsets.reference
              const u = Math.floor
              const f =
                (i === 'left' && u(c.right) > u(h.left)) ||
                (i === 'right' && u(c.left) < u(h.right)) ||
                (i === 'top' && u(c.bottom) > u(h.top)) ||
                (i === 'bottom' && u(c.top) < u(h.bottom))
              const d = u(c.left) < u(n.left)
              const p = u(c.right) > u(n.right)
              const m = u(c.top) < u(n.top)
              const g = u(c.bottom) > u(n.bottom)
              const _ =
                (i === 'left' && d) ||
                (i === 'right' && p) ||
                (i === 'top' && m) ||
                (i === 'bottom' && g)
              const v = ['top', 'bottom'].includes(i)
              const b =
                !!e.flipVariations &&
                ((v && r === 'start' && d) ||
                  (v && r === 'end' && p) ||
      ...
      inner: {
        ...
        fn: function (t) {
          ...
          const o = i.popper
          const r = i.reference
          const s = ['left', 'right'].includes(n)
          const a = !['top', 'left'].includes(n)
          return (
            (o[s ? 'left' : 'top'] =
      ...
      hide: {
        ...
        fn: function (t) {
          ...
          const n = st(t.instance.modifiers, function (t) {
      ...
      computeStyle: {
        ...
        fn: function (t, e) {
          ...
          const r = st(t.instance.modifiers, function (t) {
          ...
          const h = (function (t, e) {
            ...
            const l = r(o.width)
            const c = r(i.width)
            const h = ['left', 'right'].includes(t.placement)
            const u = t.placement.includes('-')
            const f = e ? (h || u || l % 2 == c % 2 ? r : s) : a
            const d = e ? r : a
            return {
              left: f(
          ...
          const u = n === 'bottom' ? 'top' : 'bottom'
          const f = i === 'right' ? 'left' : 'right'
          const d = ht('transform')
          let p = void 0
          let m = void 0
          if (
            ((m =
            ...
            const g = u === 'bottom' ? -1 : 1
            const _ = f === 'right' ? -1 : 1
            ;(c[u] = m * g), (c[f] = p * _), (c.willChange = u + ', ' + f)
          }
          const v = { 'x-placement': t.placement }
          return (
      ...
      applyStyle: {
        ...
        onLoad: function (t, e, n, i, o) {
          const r = nt(o, e, t, n.positionFixed)
          const s = et(
            n.placement,
            r,
            e,
  ...
  const Pt = e.fn.modal
  const Ft = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }
  const Rt = {
    ...
    return (
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              const r = s.getTransitionDurationFromElement(this._element)
              e(this._element)
      ...
      (n._triggerBackdropTransition = function () {
        ...
        if (this._config.backdrop === 'static') {
          ...
          const o = s.getTransitionDurationFromElement(this._dialog)
      ...
      (n._showElement = function (t) {
        ...
        if (i) {
          const l = s.getTransitionDurationFromElement(this._dialog)
      ...
      (n._showBackdrop = function (t) {
        ...
        if (this._isShown && this._config.backdrop) {
          if (
            ...
            return
          if (!i) return void t()
          const o = s.getTransitionDurationFromElement(this._backdrop)
          ...
          if (e(this._element).hasClass('fade')) {
            const a = s.getTransitionDurationFromElement(this._backdrop)
    ...
    for (
      var i = new window.DOMParser().parseFromString(t, 'text/html'),
        ...
        s = function (t, n) {
          ...
          if (!o.includes(i.nodeName.toLowerCase()))
  ...
  const Ut = 'tooltip'
  const Vt = e.fn[Ut]
  const Yt = new RegExp('(^|\\s)bs-tooltip\\S+', 'g')
  const zt = ['sanitize', 'whiteList', 'sanitizeFn']
  const Xt = {
    animation: 'boolean',
    template: 'string',
    ...
    return (
      ...
      (n.show = function () {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          const i = s.findShadowRoot(this.element)
          const o = e.contains(
          ...
          const a = s.getUID(this.constructor.NAME)
          r.setAttribute('id', a),
          ...
          if (e(this.tip).hasClass('fade')) {
            const f = s.getTransitionDurationFromElement(this.tip)
      ...
      (n.hide = function (t) {
        ...
        if ((e(this.element).trigger(o), !o.isDefaultPrevented())) {
          if (
            ...
            const a = s.getTransitionDurationFromElement(i)
      ...
      (n._leave = function (t, n) {
        ...
        ;(n = n || e(t.currentTarget).data(i)) ||
          ...
          e(t.currentTarget).data(i, n)),
          t &&
            (n._activeTrigger[t.type === 'focusout' ? 'focus' : 'hover'] = !1),
  ...
  const Zt = 'popover'
  const te = e.fn[Zt]
  const ee = new RegExp('(^|\\s)bs-popover\\S+', 'g')
  const ne = o({}, Jt.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template:
  ...
  const ie = o({}, Jt.DefaultType, { content: '(string|element|function)' })
  const oe = {
  ...
  const se = 'scrollspy'
  const ae = e.fn[se]
  const le = { offset: 10, method: 'auto', target: '' }
  const ce = { offset: 'number', method: 'string', target: '(string|element)' }
  const he = (function () {
    function t(t, n) {
      const i = this
      ;(this._element = t),
    ...
    return (
      (n.refresh = function () {
        ...
        ;(this._offsets = []),
          ...
          [].slice
            ...
            .map(function (t) {
              let n
              const r = s.getSelectorFromElement(t)
      ...
      (n._getConfig = function (t) {
        if (
          typeof (t = o({}, le, typeof t === 'object' && t ? t : {})).target !==
            'string' &&
    ...
    return (
      (n.show = function () {
        ...
        if (
          ...
          const r = s.getSelectorFromElement(this._element)
          if (o) {
            const a =
      ...
      (n._activate = function (t, n, i) {
        ...
        const a = i && r && e(r).hasClass('fade')
        const l = function () {
          return o._transitionComplete(t, r, i)
        }
        if (r && a) {
          const c = s.getTransitionDurationFromElement(r)
          e(r)
            .removeClass('show')
  ...
  const de = e.fn.toast
  const pe = { animation: 'boolean', autohide: 'boolean', delay: 'number' }
  const me = { animation: !0, autohide: !0, delay: 500 }
  const ge = (function () {
    function t(t, e) {
      ;(this._element = t),
        (this._config = this._getConfig(e)),
    ...
    return (
      (n.show = function () {
        ...
        if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
          ...
          if (
            ...
            const o = s.getTransitionDurationFromElement(this._element)
      ...
      (n._close = function () {
        ...
        if ((this._element.classList.remove('show'), this._config.animation)) {
          const i = s.getTransitionDurationFromElement(this._element)
